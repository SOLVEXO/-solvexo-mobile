    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _fieldLabel('What You Sell', required: true),
          const SizedBox(height: 4),
          const CustomText(
            text:
                'Selecting "In-Person / POS" is what enables the POS register for this store.',
          ...
          Obx(
            () => Wrap(
              spacing: 8,
              runSpacing: 8,
              children: kWhatYouSell.map((d) {
                final isSelected = c.editProductTypes.contains(d.option);
                return GestureDetector(
                  onTap: () => c.toggleProductType(d.option),
                  child: AnimatedContainer(
                    ...
                    child: Row(
                      ...
                      children: [
                        CustomText(text: d.emoji, fontSize: 14),
