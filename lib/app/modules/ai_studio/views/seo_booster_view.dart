...
class SeoBoosterView extends GetView<SeoBoosterController> {
  const SeoBoosterView({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.background,
      appBar: const CustomAppBarTwo(title: 'SEO Booster'),
      body: ListView(
        ...
        children: [
          Obx(() => ChoiceChipGroup<bool>(
                ...
                labelBuilder: (v) => v ? 'From a product' : 'Manual entry',
          ...
          Obx(() {
            ...
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const AiFieldLabel('Title'),
                CustomTextField(controller: controller.titleCtrl, hintText: 'Current listing title'),
                SizedBox(height: BaseSpacing.md),
                const AiFieldLabel('Description (optional)'),
                CustomTextField(controller: controller.descriptionCtrl, hintText: 'Current listing description', maxLines: 3),
              ],
            );
          }),
          SizedBox(height: BaseSpacing.md),
          const AiFieldLabel('Current tags (optional, comma separated)'),
          CustomTextField(controller: controller.tagsCtrl, hintText: 'e.g. handmade, gift, ceramic'),
          ...
          Obx(() {
            ...
            return Column(
              ...
              children: [
                ...
                GenerationOutputView(toolType: 'seo_booster', output: result.output),
                SizedBox(height: BaseSpacing.sm),
                Row(
                  children: [
                    Expanded(
